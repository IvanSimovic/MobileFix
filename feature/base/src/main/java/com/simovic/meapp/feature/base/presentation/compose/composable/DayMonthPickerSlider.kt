package com.simovic.meapp.feature.base.presentation.compose.composable
...
fun MonthDayWheelPicker(
    ...
    Row(
        ...
        WheelPicker(
            ...
            onChange = { newMonth ->
                val maxDay = YearMonth.of(date.year, newMonth).lengthOfMonth()
                val safeDay = currentDay.coerceAtMost(maxDay)
                onChange(LocalDate.of(date.year, newMonth, safeDay))
            },
        ...
        WheelPicker(
            ...
            onChange = { newDay ->
                ...
                onChange(LocalDate.of(date.year, currentMonth, safeDay))
            },
            modifier = Modifier.width(100.dp)
        )
    }
...
fun WheelPicker(
    ...
    LaunchedEffect(listState.firstVisibleItemIndex) {
        ...
        if (index in values.indices) onChange(values[index])
    }
