...
class ToggleAlbumFavoriteStatusUseCaseTest {
    ...
    @Test
    fun `ToggleAlbumFavoriteStatusUseCase when album is favorited calls removeAlbumFromFavorites and returns success`() = runBlocking {
        // given
    ...
    @Test
    fun `ToggleAlbumFavoriteStatusUseCase when album is not favorited calls addAlbumToFavorites and returns success`() = runBlocking {
        // given
    ...
    @Test
    fun `ToggleAlbumFavoriteStatusUseCase when removeAlbumFromFavorites fails returns failure`() = runBlocking {
        // given
    ...
    @Test
    fun `ToggleAlbumFavoriteStatusUseCase when addAlbumToFavorites fails returns failure`() = runBlocking {
        // given
